...
public class ScriptManager {
    ...
    public CachedScript getScript(CachedScript script, AcreResponse res) {
        ...
        if (_class_store != null) {
            ...
            _costCollector.collect("afmc");
            final long start_time = System.currentTimeMillis();
            
            StoredClass sc = _class_store.get(className);
            
            // track how long memcache gets take
            _costCollector.collect("afmw", System.currentTimeMillis() - start_time);
        ...
        Script compiledScript = compileScript(_classLoader, className, sourceName, script.getSourceText(), res);
    ...
    private Script compileScript(GeneratedClassLoader classloader, String className, String sourceName, String js_text, AcreResponse res) {
        ...
        // increment 'file compliations count' cost header
        _costCollector.collect("afcc");
        final long start_time = System.currentTimeMillis();
        ...
        Script script = compileScript(classloader, compiled);
        
        // track how long file compilation took
        _costCollector.collect("afcw", System.currentTimeMillis() - start_time);
