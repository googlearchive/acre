 ...
 */
mjt.freebase.MqlQuery = mjt.define_task (null, [{name:'query'}]);


mjt.freebase.MqlQuery.prototype.init = function () {
    this.service = mjt.freebase;
    ...
    // created lots of requirements for us.
};

mjt.freebase.MqlQuery.prototype.request = function () {
...
//
mjt.freebase.MqlQuery.prototype.find_mql_error_inside = function (d, path) {
    //mjt.log('fmei', d, path);
 ...
 *
 */
mjt.freebase.QObject = mjt.define_task(null,
                               [{ name: 'qprop' },
                                { name: 'obj' },
                                { name: 'mq' }
                                ]);

mjt.freebase.QObject.prototype.toString = function() {
 ...
 */
mjt.freebase.QObject.prototype.init = function () {
...
/*
    ...
    if (m) {
        var d = mjt.freebase.mql_directives[m[1]];
 ...
 */
    ...
    // make the MqlQuery object depend on us
 ...
 *
 */
mjt.freebase.QObject.prototype.request = function () {
...
mjt.freebase.QObject.prototype.add_property = function (k, v) {
...
// inferred types might be dirty after this
mjt.freebase.QObject.prototype.del_property = function (k) {
    if (typeof this.obj[k] === 'undefined') {
...
mjt.freebase.QObject.prototype.follow = function (path, istart) {
...
mjt.freebase.QObject.prototype.follow_all = function (path) {
// UNFINISHED
    var qo = this;
...
mjt.freebase.QObject.prototype.show = function () {
 ...
 */
mjt.freebase.QProperty = mjt.define_task(null,
                                 [{name: 'qo'},
                                  {name: 'key'}]);

mjt.freebase.QProperty.prototype.toString = function() {
    return '[' + this._task_id + ' ' + this.pathstr + ']';
};

mjt.freebase.QProperty.prototype.init = function () {
    this.service = this._factory;
    this.value = null;
    ...
    if (v instanceof Array) {
        ...
        for (var i = 0; i < v.length; i++) {
            ...
            if (typeof vv == 'object' && vv !== null) {
                this.value.push(this.service.QObject(this, vv, this.mq));
            } else {
                this.value.push(vv);
            }
        }
    } else if (typeof v == 'object' && v !== null) {
        this.value = this.service.QObject(this, v, this.mq);
    } else {
        this.value = v;
    }
 ...
 *
 */
mjt.freebase.QProperty.prototype.request = function () {
...
mjt.freebase.QProperty.prototype.show = function () {
    ...
    function showval(v) {
        ...
        } else if (v instanceof mjt.freebase.QObject) {
            v.show();
        } else if (typeof v === 'object' && v !== null) {
 ...
 *
 */
mjt.freebase.QProperty.prototype.lookup_prop_static = function () {
    var k = this.key;

    if (k in mjt.freebase.mql_directives) {
        this.schema_id = 'directive';
        this.vtype = mjt.freebase.mql_directives[k].valuetype;
        this.directive = mjt.freebase.mql_directives[k];
        return true;
    }
...
mjt.freebase.QProperty.prototype.from_pdesc = function (prop) {
 ...
 *
 */
mjt.freebase.QProperty.prototype.lookup_prop_id = function(tid) {
 ...
 */
mjt.freebase.QProperty.prototype.lookup_expected_type_id = function(qschema) {
    var k = this.key;
    var pinfo = this.lookup_prop_id(qschema.id);
 ...
 *
 */
mjt.freebase.QProperty.prototype.expand = function () {
 ...
 *
 */
mjt.freebase.QProperty.prototype.collapse = function () {
    var v = this.qo.obj[this.key];
    var vo = v;
    var v_is_array = false;
    if (v instanceof Array) {
 ...
 *
 */
mjt.freebase.QProperty.prototype.request_unique = function () {
    //mjt.log('rm', this);
 ...
 *
 */
mjt.freebase.QProperty.prototype.request_multiple = function () {
    //mjt.log('add', this);
 ...
 *
 */
mjt.freebase.QProperty.prototype.request_null = function () {
...
//
mjt.freebase.QProperty.reverse_constraint = function (q, subq) {
...
//  mjt.log('pivoted ', mjt.freebase.Schema.pivot(tree, ['cc', 'xx']));
//
//
mjt.freebase.redangle = function (tree, path) {
