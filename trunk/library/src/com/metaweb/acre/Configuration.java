...
public class Configuration implements ConfigurationMBean {
    ...
    public static enum Values {
        ...
        ACRE_WEBAPP("webapp"),
        ACRE_WEBAPP_ROOT("/"),
        ACRE_HOST_SUFFIX(DEFAULT_NAME + "." + DEFAULT_HOSTNAME),
        ...
        ACRE_CACHE_CLASS("com.metaweb.acre.script.AppEngineCache"),
        ACRE_KEYSTORE_CLASS("com.metaweb.acre.util.AppEngineKeyStore"),
