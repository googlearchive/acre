...
public class ScriptManager {
    ...
    private Script compileScript(GeneratedClassLoader classloader, String className, String sourceName, String js_text) {
        ...
        long compile_end = System.currentTimeMillis();
        _logger.debug("timings.compile", Long.toString(compile_end - start) + "ms " + className);
        ...
        if (_class_store != null) {
            ...
            _logger.debug("timings.memcache.put", Long.toString(System.currentTimeMillis() - compile_end) + "ms " + className);
        }
