...
import com.metaweb.acre.script.AcreContextFactory.AcreContext;
import com.metaweb.acre.thread.AllocationLimitedThread;
import com.metaweb.acre.util.JSFile;
import com.metaweb.acre.util.JSUtil;
import com.metaweb.acre.util.Supervisor;
import com.metaweb.acre.util.exceptions.AcreDeadlineError;
import com.metaweb.acre.util.exceptions.AcreInternalError;
import com.metaweb.acre.util.exceptions.AcreScriptError;
import com.metaweb.acre.util.exceptions.AcreThreadDeath;
import com.metaweb.acre.util.exceptions.AcreURLFetchException;
import com.metaweb.util.javascript.JSON;
import com.metaweb.util.javascript.JSONException;
import com.metaweb.util.javascript.DOM.JSAttr;
import com.metaweb.util.javascript.DOM.JSCDATASection;
import com.metaweb.util.javascript.DOM.JSCharacterData;
import com.metaweb.util.javascript.DOM.JSComment;
import com.metaweb.util.javascript.DOM.JSDOMException;
import com.metaweb.util.javascript.DOM.JSDOMImplementation;
import com.metaweb.util.javascript.DOM.JSDOMParser;
import com.metaweb.util.javascript.DOM.JSDOMParserException;
import com.metaweb.util.javascript.DOM.JSDocument;
import com.metaweb.util.javascript.DOM.JSDocumentFragment;
import com.metaweb.util.javascript.DOM.JSDocumentType;
import com.metaweb.util.javascript.DOM.JSElement;
import com.metaweb.util.javascript.DOM.JSEntity;
import com.metaweb.util.javascript.DOM.JSEntityReference;
import com.metaweb.util.javascript.DOM.JSNamedNodeMap;
import com.metaweb.util.javascript.DOM.JSNode;
import com.metaweb.util.javascript.DOM.JSNodeList;
import com.metaweb.util.javascript.DOM.JSNotation;
import com.metaweb.util.javascript.DOM.JSProcessingInstruction;
import com.metaweb.util.javascript.DOM.JSText;
import com.metaweb.util.logging.MetawebLogger;
import com.metaweb.util.resource.ResourceSource;
        ...
        try {
            ...
            try {
                _async_fetch = (AsyncUrlfetch)
                    Class.forName("com.metaweb.acre.script.AppEngineAsyncUrlfetch")
                    .newInstance();
                ...
                try {
                    _async_fetch = (AsyncUrlfetch)
                        Class.forName("com.metaweb.acre.script.NHttpAsyncUrlfetch")
                        .newInstance();
