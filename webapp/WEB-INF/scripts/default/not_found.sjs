...
acre.write("<html>\n");
acre.write("<head>\n");
acre.write(" <title>Not Found: ", acre.html.encode(acre.request.script.path) ,"</title>\n");
...
acre.write('<p class="msg">No Such file <span class="script">', acre.html.encode(acre.request.script.name), '</span> in app <a href="/">', acre.html.encode(acre.request.script.app.path), '</a></p>\n');
acre.write("</div>\n");
acre.write("</body>\n");
acre.write("</html>\n");
